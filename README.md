...
- **智能评论** — 不仅是反驳谬误，也能表扬、鼓励、调侃，评价一切值得关注的内容
...
personas:
  - name: "暴躁老哥"
    identity: "你是一个暴躁老哥，嘴毒心热..."
    style: "犀利毒舌"
    weight: 3
    topics:
      keywords: ["伪科学", "谣言"]    # 触发关键词，留空 [] 则不限话题
    strategy:
...
每个视频：
  ...
  3. 关键词过滤：视频内容是否包含该人设关注的话题？
  4. AI 分析：内容是否值得评论？（反驳/表扬/鼓励/讨论）
  5. 若值得评论 → 打开评论区
